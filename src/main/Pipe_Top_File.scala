...
//  ALU CONTROL
  ...
  //  val func7 = id_ex_mod.io.in_func7
    aluControl_mod.io.func3 := if_id_mod.io.inst_out(14, 12)
    aluControl_mod.io.func7 := if_id_mod.io.inst_out(31, 25)
...
//  branch forward
    ...
    branch_frwd_mod.io.ex_mem_memRead := ex_mem_mod.io.Rdaddr_out
